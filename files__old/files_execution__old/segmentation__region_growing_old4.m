...
function [ planes, final_array, region_idx ] = segmentation__region_growing_old4(planes)
...
%                         add_region = find([final_array.region_idx] == xyz_closest(j).region_idx, 'first');
%                        xyz_closest(j).region_colour = final_array(add_region).region_colour;
%                        
...
%--------------------------------------------------------------------------                    
                    ...
                    r_threshold = r_thresh_factor*current_point.residual_average;
...
%                     disp('')
        ...
        %else
%             % TODO not sure how much sense this makes now. Must check the 
%             % shizzle later
