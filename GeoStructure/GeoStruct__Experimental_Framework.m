...
if(struct__stats.replot_only)
    ...
    for g = 1:length(folder_name)
        save_file = [output_folder, folder_name{g},'\', folder_name{g}, '.txt'];
...
struct__stats.region_growing_k = region_growing_k;
struct__stats.normal_threshold = normal_threshold;
struct__stats.scs = scs;
