...
% Returns :: geo_struct intialisation structure  
%% ------------------------------------------------------------------------
% External none
%--------------------------------------------------------------------------
...
% Read in file
%--------------------------------------------------------------------------
geo_struct.point_cloud__read.point_cloud_file = [pathstr, '\input\data\lidar_scans\16AB_2.ply'];
...
% Terminate
%--------------------------------------------------------------------------
disp('Execution complete. Function newGeoStruct.m terminating.');
return;
end 
