...
function [ struct__planes ] = point_space__search(vec__x_point_vals, vec__y_point_vals, vec__z_point_vals, ...
    ax__axes_limits_x, ax__axes_limits_y, ax__axes_limits_z, mat__search_space_cube_vertices, var__search_space_interval, mat__cube_face_connect)
...
%--------------------------------------------------------------------------                   
                [var__strike, var__dip, var__sigma, var__centeroid, direction_cosines] = best_fit_plane__find_orientation(mat__point_matrix);
...
%--------------------------------------------------------------------------        
                ...
                [ struct__planes ] = best_fit_plane__draw(vec__point, mat__orthnorm_plane_base, var__search_space_interval, struct__planes);
...
%[ struct__planes ] = macro_plane__calculate4(struct__planes);
%[ struct__planes ] = best_fit_plane__calculate(struct__planes);
%--------------------------------------------------------------------------
% Terminate
%--------------------------------------------------------------------------
