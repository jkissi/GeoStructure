...
elseif(strcmp(button__rp_input_complete, 'Yes'))
    ...
    save_file = [output_folder, parent_folder,'\', experiment, '_final_scores', '.txt'];
...
elseif(strcmp(button__aggregate, 'Yes'))
    %get a list of files
    load_file = [output_folder, parent_folder,'\', '*', '_final_scores', '.txt'];
...
if(strcmp(button__plot_files, 'Yes'))
    ...
    for g = 1:length(folder_name)
        save_file = [output_folder, folder_name{g},'\', folder_name{g}, '_final_scores', '.txt'];
