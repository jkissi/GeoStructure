...
function [ han__search_space, idx__search_space ] = search_space__create(han__search_space, idx__search_space, mat__new_search_space, vec__search_space_color)
...
%--------------------------------------------------------------------------      
han__search_space(idx__search_space) = patch('Faces', mat__cube_face_connect, ...
